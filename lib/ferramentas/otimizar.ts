...
export const OTIMIZAR: Tool[] = [
  ...
  },
  {
    ...
    description:
      'Converte tudo para CMYK: vermelho vira C0 M100 Y100, azul vira C87 M77 Y0, e assim por diante — não é só o preto. No PDF nada é rasterizado, então o texto continua texto e o arquivo não incha; numa foto, cada pixel é recriado nas quatro tintas. O preto puro do traço sai na receita da casa, C20 M20 Y0 K100, em vez do preto de quatro tintas que a conversão por perfil devolveria sozinha.',
    icon: 'Droplets',
    accent: '6 182 212',
    category: 'Otimizar',
    busca: [
    ...
    fields: [
      ...
      },
      {
        key: 'formatoImagem',
        type: 'select',
        label: 'Se a entrada for foto, salvar como',
        default: 'jpg',
        options: [
          { value: 'jpg', label: 'JPG em CMYK', hint: 'quatro componentes, com marcador Adobe · é o que o RIP lê' },
          { value: 'psd', label: 'PSD', hint: 'quatro canais separados, sem perda · arquivo bem maior' },
        ],
        help: 'PNG não aparece aqui porque o formato não tem cor CMYK — não é limitação do programa. Mandando um PNG, o resultado sai em JPG e a nota explica.',
      },
      {
        key: 'qualidade',
        type: 'range',
        ...
        step: 1,
        unit: '%',
        showIf: { key: 'formatoImagem', equals: 'jpg' },
      },
    ],
  },
  {
