...
const CATALOGO = [...CONVERTER, ...OTIMIZAR, ...ORGANIZAR, ...EDITAR, ...GRAFICA, ...PRIVACIDADE];
...
export const CATEGORIES = ['Otimizar', 'Organizar', 'Converter', 'Editar', 'Gráfica', 'Privacidade'] as const;
